...
var inertMethods = map[string]string{
	"usage.report": "no parameters; reads only the hub-owned usage watcher and installed pace configuration, returning account identity, provenance, quota windows and sampled pace. No credentials, tokens, spend, config, decisions, probing or writes",
