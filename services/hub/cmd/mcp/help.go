...
- open_browser opens the built-in browser pane on a URL — use it to walk the
  ...
  It also takes a file:// URL for a file under the user's home or a configured
  project directory, so an HTML page you generated can be shown in place; a
  markdown file opens in the preview pane instead of the browser.
