...
func main() {
	...
	mcpFacadeURL := flag.String("mcp-facade", os.Getenv("WKS_MCP_FACADE_URL"), "verified workspacer MCP facade URL to inject into spawned sessions (empty = agents launch without Workspacer tools)")
