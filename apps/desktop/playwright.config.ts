...
export default defineConfig({
  ...
  projects: [
    ...
    { name: 'mobile', testMatch: /mobile[A-Z][A-Za-z]*\.test\.ts$/ },
    {
      name: 'renderer',
      testMatch:
        /(managerHandoff|firstUse|intentCompletion|chatTailPin|usagePacing|htmlCard|fleetReview|fleetContextMenu|recentAgents|taskInspector|statusSummary|fleetWorkflows|routingSettings)\.test\.ts$/,
    },
