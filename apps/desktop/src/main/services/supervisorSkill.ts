...
const HOME_README =
  '# Workspacer home\n\n' +
  'Your user-global work{spacer} working directory. Fleet **manager** and\n' +
  '**supervisor** agents run here rather than in some random project, so their\n' +
  'notes and digests land here.\n\n' +
...
/**
 * The user's work{spacer} home directory: `~/.workspacer`. A fleet supervisor
 * watches the whole fleet rather than living in any one project, so it opens
 * here — a stable, neutral place — instead of landing in some random agent's
