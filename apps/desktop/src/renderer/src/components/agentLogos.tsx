...
// Claude keeps its brand clay color; the others tint with `currentColor` so
...
/** Anthropic Claude mark (clay starburst). */
export const ClaudeLogo: React.FC<LogoProps> = ({ size = 14, className, style }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
