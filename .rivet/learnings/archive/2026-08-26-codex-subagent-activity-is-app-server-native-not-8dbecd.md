...
promoted: false
dropped: true
dropped_reason: superseded — this was a "we should build it" note; it was built (three wire shapes in providers/codex.rs). The shipped facts are in modules/claudemon-providers.md.
---
