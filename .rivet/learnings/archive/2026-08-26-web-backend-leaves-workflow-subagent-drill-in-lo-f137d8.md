...
promoted: false
dropped: true
dropped_reason: superseded — same as the local-IPC-only note: both methods left KNOWN_STUBS and are bus-backed. Routing rule promoted to domains/renderer-backend-seam.md.
---
