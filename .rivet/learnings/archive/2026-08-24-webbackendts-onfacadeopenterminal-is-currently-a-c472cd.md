...
promoted: false
dropped: true
dropped_reason: superseded — onFacadeOpenTerminal is now a real client.subscribe('facade.openTerminal') in webBackend.ts and sits in BUS_BACKED, not KNOWN_STUBS. The learning was an implementation plan that has since been executed.
---
